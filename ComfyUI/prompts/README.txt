...
1): The prompts are, and must be, txt files named after the functions they go to.
    ...
    Prompts for functions  using filenames are appended with "_filenames" 
    Changing prompt names without also changing the function to reflect the changes will break the function.
